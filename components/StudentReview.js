...
const StudentReview = (props) => {
  return (
    <Card style={{ width: "600px",minWidth:"570px", height:"260px", backgroundColor: "rgb(217,217,217)"}}>
        <Row className="h-100 w-100">
          <Col xs={3} className="p-0 text-center position-relative d-flex flex-column">
          ...
          <Col xs={9} style={{padding: "0"}}>
            <Card.Body style={{ height: "100%", display: "flex", flexDirection: "column", justifyContent: "space-between", paddingTop:"16px", paddingBottom:"8px", paddingLeft:"0"}}>
